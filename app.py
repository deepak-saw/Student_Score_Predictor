...
# =========================
    ...
    with k1:
        st.markdown("""<div class="kpi-card">
            ...
            <div class="kpi-sub">ML-powered engine</div>
        </div>""", unsafe_allow_html=True)
    with k2:
        st.markdown("""<div class="kpi-card">
            <div class="kpi-icon">📊</div>
            <div class="kpi-label">Visual Analytics</div>
            <div class="kpi-sub">Charts & graphs</div>
        </div>""", unsafe_allow_html=True)
    with k3:
        st.markdown("""<div class="kpi-card">
            <div class="kpi-icon">🎯</div>
            <div class="kpi-label">95% Accuracy</div>
            <div class="kpi-sub">High precision model</div>
        </div>""", unsafe_allow_html=True)
    with k4:
        st.markdown("""<div class="kpi-card">
            <div class="kpi-icon">⚡</div>
            <div class="kpi-label">Instant Results</div>
            <div class="kpi-sub">Under 1 second</div>
        </div>""", unsafe_allow_html=True)
    ...
    if st.button("🚀  Predict My Score"):
        ...
        with r2:
            ...
            bar_fig = px.bar(
                ...
                title="Your Key Metrics Breakdown",
                text="Value"
            )
