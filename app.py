...
def show_profile_widget():
    ...
    # ── Top-right button ──
    # We use a columns hack to float it to the right
    ...
    # ── Inject avatar style to the last button ──
    st.markdown("""
    <style>
    /* Style the profile avatar button */
    ...
    if st.session_state.profile_open:
        with st.container():
            ...
            # ── Action buttons inside expander-style container ──
...
def show_student_dashboard():
    ...
    if st.button("🚀  Predict My Score"):
        ...
        # Save last result to student profile
